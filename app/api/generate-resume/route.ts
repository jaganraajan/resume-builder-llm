...
export async function POST(req: Request) {
    try {
        const { jobDescription, experiences, projects } = await req.json();
        ...
        TASKS:
        1. Rewrite the bullet points for each experience and project.
        2. Focus on using keywords from the job description.
        3. Quantify achievements where possible (e.g., "Improved performance by X%").
